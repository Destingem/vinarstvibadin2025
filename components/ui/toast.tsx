...
// Jednoduchá implementace Toast bez Radix UI pro odstranění závislostí
...
>(({ className, ...props }, ref) => (
  <button
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-80 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none",
      className
    )}
    {...props}
  >
